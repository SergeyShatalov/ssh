...
local w_clamp:QWORD, h_clamp:QWORD, coord:QWORD, filter:QWORD, operation:QWORD, alpha0:DWORD, alpha1:DWORD, _dst_bar:stk_bar
		call init_base_modify								; инициализаци€ основных параметров модификатора
		; обрезка координат
		call asm_clip_bar
		jc _fin
		mov r14, rcx
		...
		call init_addressing								; инициализаци€ адресации координат(mirror, repeat, clamp)
...
pixLum:		pand mm0, mm6
			...
			por mm0, mm6
			ret
pixMull:	pand mm0, mm6				; сохран€ем альфу
			punpcklbw mm4, mm3
			punpcklbw mm1, mm3
			pmullw mm4, mm1
			packuswb mm4, mm4
