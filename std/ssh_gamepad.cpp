...
namespace ssh
{
	...
	static _ssh_xenable _enable((_ssh_xenable)ssh_dll_proc(L"xinput1_3.dll", "XInputEnable", 0));
	static _ssh_xgstate _gstate((_ssh_xgstate)ssh_dll_proc(L"xinput1_3.dll", "XInputGetState", 0));
	static _ssh_xsstate _sstate((_ssh_xsstate)ssh_dll_proc(L"xinput1_3.dll", "XInputSetState", 0));
	static _ssh_xcaps _caps((_ssh_xcaps)ssh_dll_proc(L"xinput1_3.dll", "XInputGetCapabilities", 0));
